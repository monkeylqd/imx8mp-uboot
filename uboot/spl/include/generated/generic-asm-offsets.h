...
#define GENERATED_GBL_DATA_SIZE 432 /* (sizeof(struct global_data) + 15) & ~15	// */
#define GENERATED_BD_INFO_SIZE 176 /* (sizeof(struct bd_info) + 15) & ~15	// */
#define GD_SIZE 432 /* sizeof(struct global_data)	// */
